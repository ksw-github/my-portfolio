      ...
      <footer className="text-center px-[5%] py-10 border-t dark:border-white/[0.06] border-black/[0.06] text-theme-sub text-sm">
        ...
        <div className="flex justify-center gap-5 mt-4">
          ...
          <a
            ...
            className="text-theme-sub hover:text-coral transition-colors"
            title="GitHub"
          >
          ...
          <button
            ...
            className="text-theme-sub hover:text-coral transition-colors border-none bg-transparent cursor-pointer p-0"
            title="Email"
          >
